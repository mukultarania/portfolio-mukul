...
const Hero = () => {
  return (
    <section id="home" className="h-screen flex items-center relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-gray-50">
      <div className="absolute inset-0 bg-grid-pattern opacity-5"></div>
      <div className="container mx-auto px-6 relative">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="md:w-1/2 space-y-8">
            <div className="space-y-4">
              <h2 className="text-blue-600 font-semibold tracking-wide uppercase">Welcome to my portfolio</h2>
              ...
              <p className="text-xl text-gray-600 max-w-2xl">
                A highly motivated and performance-driven professional with a strong foundation in Software Development,
